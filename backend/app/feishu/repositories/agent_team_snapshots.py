...
[OUTPUT]: 对外提供 AgentTeamSnapshotsRepo 类
[POS]: repositories 包的具体实现，封装 AgentTeamSnapshots 表的 CRUD 与领域查询
...
# ============================================================
# agent team snapshots repository
# ============================================================


class AgentTeamSnapshotsRepo(BaseRepository):
    """Repository for the AgentTeamSnapshots table."""

    def __init__(self, client: FeishuClient, app_token: str, table_id: str) -> None:
        from app.feishu.table_map import FIELD_MAPS

        super().__init__(client, app_token, table_id, FIELD_MAPS["agent_team_snapshots"])
    ...
    def find_by_chapter(self, book_id: str, chapter_no: int) -> list[dict]:
        """Return snapshots for a specific chapter of a book."""
        return self.list(
            filter_expr=(
